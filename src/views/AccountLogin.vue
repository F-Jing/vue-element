<template>
  <div class="account-login-container">
    <div class="account-login-bd">
      ...
      <div class="company-info-desc">小具影响力的Web设计规范</div>
        ...
        <div class="login-form-container">
          <div class="login-form-password" v-show="passwordMode">
            <el-form :model="passwordFrom" status-icon :rules="passwordRules" ref="passwordFrom">
              ...
              <el-form-item>
                <el-button type="primary" style="width: 100%" @click="submitForm('passwordFrom')">登录</el-button>
              </el-form-item>
            </el-form>
          </div>
          <div class="login-form-phone" v-show="!passwordMode">
            <el-form :model="smsFrom" status-icon :rlues="smsRules" ref="smsFrom">
              <el-form-item prop="phone">
                <el-input
                  type="number"
                  prefix-icon="el-icon-mobile-phone"
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          //   this.$router.replace({ name: "DashboardGeneral" });
          // }
          let params = formName === "passwordFrom" ? this.passwordFrom : this.smsFrom;
          let loginRequest =
